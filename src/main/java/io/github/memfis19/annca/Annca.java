...
public class Annca {
    ...
    public void launchCamera() {
        ...
        if(anncaConfiguration.getAssessmentRemainingTimer()>0){
            cameraIntent.putExtra(AnncaConfiguration.Arguments.ASSESSMENT_REMAINING_TIMER,anncaConfiguration.getAssessmentRemainingTimer());
        }
