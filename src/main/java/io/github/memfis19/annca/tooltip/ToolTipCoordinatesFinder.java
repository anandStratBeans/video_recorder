...
public class ToolTipCoordinatesFinder {
    ...
    public static int left=0,right=0,top=0,bottom=0;
    ...
    private static void AdjustHorizotalRightAlignmentOutOfBounds(TextView tipView, ViewGroup root,
        ...
        if (point.x < rootLeft){
            ...
            tipView.setLayoutParams(params);
            if(isMargin) {
                ViewGroup.MarginLayoutParams p = (ViewGroup.MarginLayoutParams) tipView.getLayoutParams();
    ...
    public static void setMarginView(int leftMargin, int topMargin, int rightMargin, int bottomMargin){
        left=leftMargin;
        right=topMargin;
        bottom=rightMargin;
        top=bottomMargin;
