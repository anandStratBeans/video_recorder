...
public final class AnncaConfiguration {
    ...
    public interface Arguments {
        ...
        String ASSESSMENT_REMAINING_TIMER="assessmentRemainingTimer";
    }
    ...
    public static int mediaQualityHelper=-1;

    @CameraFace
//    private int cameraFace = CAMERA_FACE_REAR;
    private int cameraFace = CAMERA_FACE_FRONT;
    ...
    public static long miliseondPssed=0;
...
//        }
        ...
        public Builder setMediaQuality(@MediaQuality int mediaQuality) {
            ...
            mediaQualityHelper=mediaQuality;
            return this;
        }
        ...
        public Builder setMinimumVideoDuration(@IntRange(from = 1000, to = Integer.MAX_VALUE) int minimumVideoDurationInMilliseconds) {
            ...
            miliseondPssed=minimumVideoDurationInMilliseconds;
            return this;
        }
        ...
        public Builder setAssessmentRemainingTimer(int assessmentRemainingTimer){
            anncaConfiguration.assessmentRemainingTimer=assessmentRemainingTimer;
            return this;
        }
